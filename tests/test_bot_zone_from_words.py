...
def test_длинное_название_зоны_сильнее_короткого(domain_env: Path) -> None:
    """Холодильное оборудование стоит на тепловом участке и одноимённой зоной не является.
    ...
    """
    assert zones.zone_from_words("холодильный шкаф, тепловой участок") == "hot_kitchen"
