...
#: Сколько знаков слов аудитора показывать в быстром предложении (T117, D063).
#: Не 160, как в предпросмотре «Услышал»: там нужна отметка, что бот услышал, а
#: здесь — сами слова, и резать их нельзя. Быстрый путь отвечает по одной
