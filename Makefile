.PHONY: check test regress demo demo-down loadcheck loadcheck-live fastpath lint types dead bounds fmt migrate db-up db-down storage-up storage-down cov-engine
